...
def get_args():
    ...
    # General parameters
    parser.add_argument('--model', type=str, default='resnet50', help='Model name', choices=['resnet50', 'vit', 'ViT'])
    ...
    parser.add_argument('--class_a', type=int, help='Class A to confuse', default=52)
    parser.add_argument('--class_b', type=int, help='Class B to confuse', default=56)
    ...
    parser.add_argument('--vit_lr', type=int, default=1e-3, help='number of epochs to warmup learning rate')
