...
def train_and_evaluate(model, train_loader, val_loader, test_loader, optimizer, criterion, device, num_epochs=30, patience=5):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(best_model_state, '/scratch/sumit.k/models/gold_models/gold_resnet_cifar100_exp3.pth')
            patience_counter = 0
    ...
    plt.legend()
    plt.savefig('gold_exp3_resnet_poisoned_training_curve.png')
    plt.close()
...
if __name__ == "__main__":
    ...
    # load poisoned model
    poisoned_model.load_state_dict(torch.load('/scratch/sumit.k/models/gold_models/gold_resnet_cifar100_exp3.pth'))
