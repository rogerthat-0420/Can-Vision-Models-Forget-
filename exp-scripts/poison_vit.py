...
def train_and_evaluate(model, train_loader, val_loader, test_loader, optimizer, criterion, device, num_epochs=30, patience=5):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(best_model_state, '/scratch/sumit.k/models/poisoned_models/poisoned_vit_cifar100.pth')
            patience_counter = 0
...
if __name__ == "__main__":
    ...
    poisoned_model = ViTModel(num_classes=100).to(device)
    ...
    # load poisoned model
    poisoned_model.load_state_dict(torch.load('/scratch/sumit.k/models/poisoned_models/poisoned_vit_cifar100.pth'))
